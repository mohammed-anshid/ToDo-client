...
import { signup } from '../services/userApi/userRequests';
...
function Signup() {
  ...
  const handleSubmit = async(event) => {
    try {
        ...
        const formValid = validateForm(setErrors,formData)
        if(formValid) {
